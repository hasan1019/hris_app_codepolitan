        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Employee</h3>
                    <p class="text-subtitle text-muted">Handle Employees Detail</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="address" value="{{ old('address') }}" required>{{ old('address', $employee->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
